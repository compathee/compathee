...
final class Choir_Rehearsal_Admin {
	...
	public static function enqueue_assets( string $hook ): void {
		...
		wp_localize_script(
			...
			array(
				...
				'openPiano'      => __( 'Open piano', 'choir-rehearsal' ),
				'openMetronome'  => __( 'Open metronome', 'choir-rehearsal' ),
				...
				<div class="choir-recorder-panel__actions">
					<div class="choir-recorder-panel__start-row">
						...
						<button
							...
							title="<?php esc_attr_e( 'Open piano', 'choir-rehearsal' ); ?>"
							aria-label="<?php esc_attr_e( 'Open piano', 'choir-rehearsal' ); ?>"
							aria-expanded="false"
						...
						<button
							...
							title="<?php esc_attr_e( 'Open metronome', 'choir-rehearsal' ); ?>"
							aria-label="<?php esc_attr_e( 'Open metronome', 'choir-rehearsal' ); ?>"
							aria-expanded="false"
	...
	private static function icon_svg( string $name ): string {
		$icons = array(
			...
			'piano'     => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path fill="currentColor" d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-9 16.5v-4.5h1V4.5h2v10.5h1v4.5h-4zM8 19.5H5.5c-.55 0-1-.45-1-1V5.5c0-.55.45-1 1-1H7v10.5h1v4.5zm8-4.5h1V4.5h1.5c.55 0 1 .45 1 1v13c0 .55-.45 1-1 1H16v-4.5z"/></svg>',
			'metronome' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14" aria-hidden="true" focusable="false"><path fill="currentColor" d="M12.5 2l7.5 18H5L12.5 2zm0 3.2L7.4 18h10.2L12.5 5.2zM11 10h1.5v5H11v-5zm0 6h1.5v1.5H11V16z"/></svg>',
