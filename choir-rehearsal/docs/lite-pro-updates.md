...
| **Choir Rehearsal Pro** (`choir-rehearsal-pro.zip`) | Add-on. Unlocks search, unlimited tracks, microphone recording, and Play preview in the song editor. | Paying customers only |
...
Lite limits: 4 voice tracks per song, no microphone recording, no song search, no Play preview in the song editor.
...
5. Check a song: Record and Play buttons visible, more than 4 tracks allowed, search on the public library.
