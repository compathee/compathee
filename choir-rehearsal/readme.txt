...
* Song list: globe icon for public songs when logged in; spacing between PDF and globe badges

= 0.4.58 =

* Force HTTPS for PDF and audio attachment URLs on SSL pages (fixes mixed-content blank PDF/waveforms in wp-admin)
