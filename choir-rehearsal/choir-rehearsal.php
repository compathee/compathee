...
define( 'CHOIR_REHEARSAL_VERSION', '0.3.8' );
...
define( 'CHOIR_REHEARSAL_DOCS_URL', 'https://github.com/compathee/compathee/blob/main/choir-rehearsal/docs/product-page.html' );
