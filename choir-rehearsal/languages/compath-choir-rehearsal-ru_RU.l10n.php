...
return [
    ...
    'messages' => [
        ...
        'Activation adds WordPress roles %1$s (listen) and %2$s (manage songs). Assign them under Users. Settings stay limited to %3$s. Public songs remain open to %4$s.' => 'При активации создаются роли WordPress %1$s (прослушивание) и %2$s (управление песнями). Назначьте их в разделе Пользователи. Настройки доступны только роли %3$s. Публичные песни остаются открытыми для роли %4$s.',
        'Active' => 'Активен',
        ...
        'Ask someone with the %1$s role to assign you the %2$s or %3$s role to open private rehearsal songs.' => 'Попросите пользователя с ролью %1$s назначить вам роль %2$s или %3$s, чтобы открывать закрытые репетиционные песни.',
        ...
        'Choir Rehearsal Settings' => 'Настройки Choir Rehearsal',
        ...
        'Public songs above are open to everyone. Ask someone with the %1$s role to assign you the %2$s or %3$s role for the full rehearsal library.' => 'Публичные песни выше открыты для всех. Попросите пользователя с ролью %1$s назначить вам роль %2$s или %3$s для полной библиотеки репетиций.',
        ...
        'Role names %1$s, %2$s, %3$s, and %4$s are kept in English on purpose.' => 'Имена ролей %1$s, %2$s, %3$s и %4$s намеренно остаются на английском.',
        ...
        'Feedback' => 'Отзыв',
        '%1$s, %2$s, %3$s, and %4$s can send a wish or bug from the song list. The site creates a GitHub issue. Lite and Pro both include this.' => '%1$s, %2$s, %3$s и %4$s могут отправить пожелание или ошибку из списка песен. Сайт создаёт задачу на GitHub. Это есть и в Lite, и в Pro.',
        ...
        'Feedback is not configured.' => 'Форма отзывов не настроена.',
        'Please wait before sending more feedback.' => 'Подождите перед отправкой следующего отзыва.',
        'Could not send feedback. Please ask someone with the %s role to check the GitHub token.' => 'Не удалось отправить отзыв. Попросите пользователя с ролью %s проверить токен GitHub.',
        'Could not send feedback. Please ask someone with the %s role to check the GitHub repository.' => 'Не удалось отправить отзыв. Попросите пользователя с ролью %s проверить репозиторий GitHub.',
        'Short summary' => 'Краткое описание',
        'What happened, or what you wish for' => 'Что случилось или какое у вас пожелание',
        'YouTube video player' => 'Видеоплеер YouTube',
        'Public — available without login' => 'Публичная — доступна без входа',
    ],
];
