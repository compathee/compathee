...
return [
    ...
    'messages' => [
        '%1$s — %2$s' => '%1$s — %2$s',
        '%1$s, %2$s, %3$s, and %4$s can send a wish or bug from the song list. Lite and Pro both include this.' => '%1$s, %2$s, %3$s и %4$s могут отправить пожелание или ошибку из списка песен. Это есть и в Lite, и в Pro.',
        ...
        'Request received, case number %1$s. A confirmation has been sent to %2$s.' => 'Запрос получен, номер обращения %1$s. Подтверждение отправлено на %2$s.',
        ...
        'Your email is used only to answer this request.' => 'Электронная почта используется только для ответа на этот запрос.',
