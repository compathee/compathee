...
return [
    ...
    'messages' => [
        ...
        'Feedback' => 'Tagasiside',
        'Singer, Voice Leader, Administrator, and guests can send a wish or bug from the song list. The site creates a GitHub issue. Lite and Pro both include this.' => 'Singer, Voice Leader, Administrator ja külalised saavad laulude loendist saata soovi või veateate. Sait loob GitHubi teema. See on olemas nii Lites kui Pros.',
        ...
        'Could not send feedback. Please ask an administrator to check the GitHub token.' => 'Tagasisidet ei õnnestunud saata. Palu administraatoril kontrollida GitHubi tunnust.',
        'Could not send feedback. Please ask an administrator to check the GitHub repository.' => 'Tagasisidet ei õnnestunud saata. Palu administraatoril kontrollida GitHubi hoidlat.',
