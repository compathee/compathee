...
return [
    ...
    'messages' => [
        ...
        'Activation adds WordPress roles %1$s (listen) and %2$s (manage songs). Assign them under Users. Settings stay limited to %3$s. Public songs remain open to %4$s.' => 'Aktiveerimine lisab WordPressi rollid %1$s (kuulamine) ja %2$s (lugude haldamine). Määra need menüüs Kasutajad. Seaded jäävad ainult rollile %3$s. Avalikud lood jäävad avatuks rollile %4$s.',
        'Active' => 'Aktiivne',
        ...
        'Ask someone with the %1$s role to assign you the %2$s or %3$s role to open private rehearsal songs.' => 'Palu kasutajal rolliga %1$s määrata sulle roll %2$s või %3$s, et avada privaatsed prooviloosid.',
        ...
        'Choir Rehearsal Settings' => 'Choir Rehearsal seaded',
        ...
        'Public songs above are open to everyone. Ask someone with the %1$s role to assign you the %2$s or %3$s role for the full rehearsal library.' => 'Ülal olevad avalikud lood on kõigile avatud. Palu kasutajal rolliga %1$s määrata sulle roll %2$s või %3$s, et avada täielik prooviraamatukogu.',
        ...
        'Role names %1$s, %2$s, %3$s, and %4$s are kept in English on purpose.' => 'Rollinimed %1$s, %2$s, %3$s ja %4$s jäävad teadlikult ingliskeelseks.',
        ...
        '— Select —' => '— Vali —',
        'Hide video' => 'Peida video',
        'Optional. On the song page a button opens the official YouTube player (video stays visible). Not for downloading audio.' => 'Valikuline. Laulu lehel nupp avab ametliku YouTube mängija (video jääb nähtavaks). Mitte heli allalaadimiseks.',
        'Watch reference video' => 'Vaata viitevideot',
        'YouTube reference' => 'YouTube viide',
        'Audio' => 'Audio',
        'YouTube' => 'YouTube',
        'YouTube URL' => 'YouTube URL',
        'Track source' => 'Raja allikas',
        'Official YouTube player opens on the song page (video stays visible). Not for downloading audio.' => 'Laulu lehel avaneb ametlik YouTube mängija (video jääb nähtavaks). Mitte heli allalaadimiseks.',
        'Preview video' => 'Video eelvaade',
        'Watch video' => 'Vaata videot',
        'Has YouTube track' => 'Sisaldab YouTube rada',
        'Sending…' => 'Saadan…',
        'Send' => 'Saada',
        'View issue' => 'Vaata teemat',
        'Could not send feedback. Please try again later.' => 'Tagasisidet ei õnnestunud saata. Proovi hiljem uuesti.',
        'Send feedback' => 'Saada tagasiside',
        'Wish, bug, or other note about Choir Rehearsal.' => 'Soov, viga või muu märkus Choir Rehearsal’i kohta.',
        'Type' => 'Tüüp',
        'Bug' => 'Viga',
        'Wish' => 'Soov',
        'Title' => 'Pealkiri',
        'Description' => 'Kirjeldus',
        'Contact email (optional)' => 'Kontaktmeil (valikuline)',
        'Feedback' => 'Tagasiside',
        '%1$s, %2$s, %3$s, and %4$s can send a wish or bug from the song list. The site creates a GitHub issue. Lite and Pro both include this.' => '%1$s, %2$s, %3$s ja %4$s saavad laulude loendist saata soovi või veateate. Sait loob GitHubi teema. See on olemas nii Lites kui Pros.',
        'GitHub repository for feedback' => 'GitHubi hoidla tagasiside jaoks',
        'Issues are created in this repository. Use owner/name, for example compathee/compathee.' => 'Teemad luuakse selles hoidlas. Kasuta vormi omanik/nimi, näiteks compathee/compathee.',
        'GitHub token' => 'GitHubi tunnus',
        'A token is saved.' => 'Tunnus on salvestatud.',
        'Remove saved token' => 'Eemalda salvestatud tunnus',
        'Create a fine-grained personal access token at GitHub → Settings → Developer settings → Personal access tokens → Fine-grained tokens. Grant only this repository Issues: Read and write. Paste the token here. It stays on the server and is not shown on the rehearsal page. Leave blank to keep the saved token.' => 'Loo peeneteraline isiklik juurdepääsutunnus: GitHub → Settings → Developer settings → Personal access tokens → Fine-grained tokens. Anna ainult sellele hoidlale õigus Issues: Read and write. Kleebi tunnus siia. See jääb serverisse ega ilmu proovilehele. Tühjaks jätmine säilitab salvestatud tunnuse.',
        'That GitHub token does not look valid. The saved token was left unchanged.' => 'See GitHubi tunnus ei tundu kehtiv. Salvestatud tunnus jäi muutmata.',
        'Thank you. Feedback sent as issue #%d.' => 'Aitäh. Tagasiside on saadetud teemana #%d.',
        'Thank you. Feedback sent.' => 'Aitäh. Tagasiside on saadetud.',
        'Please enter a type, title, and description.' => 'Sisesta tüüp, pealkiri ja kirjeldus.',
        'Feedback is not configured.' => 'Tagasiside ei ole seadistatud.',
        'Please wait before sending more feedback.' => 'Oota enne järgmise tagasiside saatmist.',
        'Could not send feedback. Please ask someone with the %s role to check the GitHub token.' => 'Tagasisidet ei õnnestunud saata. Palu kasutajal rolliga %s kontrollida GitHubi tunnust.',
        'Could not send feedback. Please ask someone with the %s role to check the GitHub repository.' => 'Tagasisidet ei õnnestunud saata. Palu kasutajal rolliga %s kontrollida GitHubi hoidlat.',
        'Short summary' => 'Lühike kokkuvõte',
        'What happened, or what you wish for' => 'Mis juhtus või mida soovid',
        'YouTube video player' => 'YouTube’i videopleier',
    ],
];
