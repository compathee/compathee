...
return [
    ...
    'messages' => [
        '%1$s — %2$s' => '%1$s — %2$s',
        '%1$s, %2$s, %3$s, and %4$s can send a wish or bug from the song list. Lite and Pro both include this.' => '%1$s, %2$s, %3$s ja %4$s saavad laulude loendist saata soovi või veateate. See on olemas nii Lites kui Pros.',
        ...
        'Request received, case number %1$s. A confirmation has been sent to %2$s.' => 'Päring vastu võetud, juhtumi number %1$s. Kinnitus on saadetud aadressile %2$s.',
        ...
        'Your email is used only to answer this request.' => 'Teie e-posti kasutame ainult sellele päringule vastamiseks.',
